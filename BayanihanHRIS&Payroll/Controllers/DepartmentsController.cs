...
namespace BayanihanHRIS_Payroll.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,ParentDepartmentId")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,ParentDepartmentId")] Department department)
        {
            if (id != department.Id)
            {
                return NotFound();
